      ...
      <div class="container pt-5 pb-4">
          <div class="row g-5">
              <div class="col-lg-3 col-md-6">
                  ...
                  <p class="mt-4 text-light">A Alô Brasil trás modernidade e praticidade, que marcam o momento digital do
              ...
              <div class="col-lg-3 col-md-6">
                  ...
                  <div class="mt-4 d-flex flex-column help-link">
                      <a href="" class="mb-2 text-white"><i
                              class="fas fa-angle-right text-secondary me-2"></i>Termos de uso</a>
                      <a href="" class="mb-2 text-white"><i
                              class="fas fa-angle-right text-secondary me-2"></i>Politiica de Privacidade</a>
                      {{-- <a href="" class="mb-2 text-white"><i
              ...
              <div class="col-lg-3 col-md-6">
                  <a href="{{ route('home.contatos.index') }}" class="h3 text-secondary">Contatos</a>
                  <div class="text-white mt-4 d-flex flex-column contact-link">
                      <a href="#" class="pb-3 text-light border-bottom border-primary"><i
                              class="fas fa-map-marker-alt text-secondary me-2"></i> Av Chico Brito, N 1317</a>
          ...
          <div class="row">
              <div class="col-md-6 text-center text-md-start">
                  <span class="text-light"><a href="#" class="text-secondary"><i
                              class="fas fa-copyright text-secondary me-2"></i>Alô Brasil</a>. Todos os direitos
                      reservados.
                  </span>
              </div>
